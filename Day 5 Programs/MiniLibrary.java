...
class Magazine extends LibraryItem {
    ...
    public Magazine(String title, int itemId, Double price, String issueMonth) {
        super(title, itemId, price);
        ...
        do {
            ...
            switch (choice) {
                case 1:
                    ...
                    items.add(new Book(bTitle, bId, bPrice, author));
                ...
                case 2:
                    ...
                    items.add(new Magazine(mTitle, mId, mPrice, month));
